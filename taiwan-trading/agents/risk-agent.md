...
| 指數 | 收盤 | 漲跌 | 漲跌幅 | 狀態 |
|------|------|------|--------|------|
| TAIEX | {taiex} | {change_points} | {change_pct}% | {market_status} |

**選股決策**

| 代號 | 名稱 | 決策 | 進場價 | 停損 | 目標一 | 目標二 | 部位 | 盈虧比 |
|------|------|------|--------|------|--------|--------|------|--------|
| {code} | {name} | ✅ 買進 | {entry} | {stop}（{stop_pct}%） | {t1}（+10%） | {t2}（+15%） | {size}% | {rr}:1 |
| {code} | {name} | 👀 觀察 | — | — | — | — | — | — |
| {code} | {name} | ❌ 排除 | — | — | — | — | — | — |
